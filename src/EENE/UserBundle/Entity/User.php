...
class User extends BaseUser
{
    ...
    */
    ...
    /*
    * Créer le fichier log de l'utilisateur en serveur (/web/$userdirectory/$username_logfile)
    */
    public function createUserFileLog(){
         //créer un fichier log vide en serveur pour l'utilisateur 
        if (!file_exists($this->getUploadUserDir().'/'.$this->getUsername()."_logfile")){
            file_put_contents($this->getUploadUserDir().'/'.$this->getUsername()."_logfile", "");
         }
     }
    /*
